...
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.APPLICATION_TO_END_CIVIL_PARTNERSHIP;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.APPLY_FOR_DIVORCE;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.COURT_EMAIL;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.DIVORCE_APPLICATION;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.END_CIVIL_PARTNERSHIP;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.FIRST_NAME;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.LAST_NAME;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.RELATIONSHIP;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.RELATIONSHIP_COURT_HEADER;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.SIGN_IN_DISSOLUTION_URL;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.SIGN_IN_DIVORCE_URL;
import static uk.gov.hmcts.divorce.api.constant.NotificationConstants.SIGN_IN_URL_NOTIFY_KEY;
