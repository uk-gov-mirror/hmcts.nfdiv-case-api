package uk.gov.hmcts.divorce.api.solicitor;
...
import uk.gov.hmcts.divorce.api.solicitor.page.ClaimForCosts;
import uk.gov.hmcts.divorce.api.solicitor.page.FinancialOrders;
import uk.gov.hmcts.divorce.api.solicitor.page.LanguagePreference;
import uk.gov.hmcts.divorce.api.solicitor.page.MarriageCertificateDetails;
import uk.gov.hmcts.divorce.api.solicitor.page.OtherLegalProceedings;
import uk.gov.hmcts.divorce.api.solicitor.page.RespondentServiceDetails;
import uk.gov.hmcts.divorce.api.solicitor.page.SolAboutThePetitioner;
import uk.gov.hmcts.divorce.api.solicitor.page.SolAboutTheRespondent;
import uk.gov.hmcts.divorce.api.solicitor.page.SolAboutTheSolicitor;
import uk.gov.hmcts.divorce.api.solicitor.service.SolicitorCreatePetitionService;
